...
(time < 8 && traffic < 5) ? console.log("You left before "+ time +", so you will make it to work on time!") : console.log("You left after "+ time +", so you will not make it to work on time today!");
