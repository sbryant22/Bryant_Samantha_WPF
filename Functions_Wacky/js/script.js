...
var total = functionName(players, monthsPerYear); // to calculate equation for console.log

// Function with else if statement:

//var quidditchTeam =
function functionName(players, monthsPerYear){ // anonymous function for Quidditch Team
