...
(duplicate < 25 && rotate > 10) ? console.log("Your StarBurst Design will come out great with "+ total +" rotations!") : console.log("Your StarBurst Design will come out too cluttered with "+ total +" rotations!");
